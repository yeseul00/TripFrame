...
- `src/widget/TripWidgetProvider.tsx` — Android home screen widget UI (D-day + trip name)
...
- **Phase 6** (ACTIVE — TASK-100~108): D-day widget (Android), CI/CD (GitHub Actions), Sentry, closed beta
  ...
  - TASK-102 (D-day 위젯 POC) 🔄 IN PROGRESS — `android/` prebuild 완료, `src/widget/` 기본 구조 생성됨
  - TASK-103~108: 미시작
